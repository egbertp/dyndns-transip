...
var (
	// Oct 1, 2020 the A record for api6.ipify.org will be removed to make the subdomain
	// only for IPv6 requests. For universal access please use api64.ipify.org.
